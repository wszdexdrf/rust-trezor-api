...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _id\x18\x02\x20\x02(\x0cR\x07chainId\x12E\n\x06header\x18\x03\x20\x02(\
    \x0b2-.hw.trezor.messages.eos.EosSignTx.EosTxHeaderR\x06header\x12\x1f\n\
    \x0bnum_actions\x18\x04\x20\x02(\rR\nnumActions\x1a\xf0\x01\n\x0bEosTxHe\
    ...
    \x20\x02(\x0b26.hw.trezor.messages.eos.EosTxActionAck.EosActionCommonR\
    ...
    nknown\x1a:\n\x08EosAsset\x12\x16\n\x06amount\x18\x01\x20\x02(\x12R\x06a\
    mount\x12\x16\n\x06symbol\x18\x02\x20\x02(\x04R\x06symbol\x1aJ\n\x12EosP\
    ermissionLevel\x12\x14\n\x05actor\x18\x01\x20\x02(\x04R\x05actor\x12\x1e\
    ...
    \x20\x02(\x04R\x04name\x12_\n\rauthorization\x18\x03\x20\x03(\x0b29.hw.t\
    rezor.messages.eos.EosTxActionAck.EosPermissionLevelR\rauthorization\x1a\
    \xa8\x01\n\x11EosActionTransfer\x12\x16\n\x06sender\x18\x01\x20\x02(\x04\
    R\x06sender\x12\x1a\n\x08receiver\x18\x02\x20\x02(\x04R\x08receiver\x12K\
    \n\x08quantity\x18\x03\x20\x02(\x0b2/.hw.trezor.messages.eos.EosTxAction\
    Ack.EosAssetR\x08quantity\x12\x12\n\x04memo\x18\x04\x20\x02(\tR\x04memo\
    \x1a\x8b\x02\n\x11EosActionDelegate\x12\x16\n\x06sender\x18\x01\x20\x02(\
    \x04R\x06sender\x12\x1a\n\x08receiver\x18\x02\x20\x02(\x04R\x08receiver\
    \x12R\n\x0cnet_quantity\x18\x03\x20\x02(\x0b2/.hw.trezor.messages.eos.Eo\
    sTxActionAck.EosAssetR\x0bnetQuantity\x12R\n\x0ccpu_quantity\x18\x04\x20\
    \x02(\x0b2/.hw.trezor.messages.eos.EosTxActionAck.EosAssetR\x0bcpuQuanti\
    ty\x12\x1a\n\x08transfer\x18\x05\x20\x02(\x08R\x08transfer\x1a\xf1\x01\n\
    \x13EosActionUndelegate\x12\x16\n\x06sender\x18\x01\x20\x02(\x04R\x06sen\
    der\x12\x1a\n\x08receiver\x18\x02\x20\x02(\x04R\x08receiver\x12R\n\x0cne\
    t_quantity\x18\x03\x20\x02(\x0b2/.hw.trezor.messages.eos.EosTxActionAck.\
    EosAssetR\x0bnetQuantity\x12R\n\x0ccpu_quantity\x18\x04\x20\x02(\x0b2/.h\
    w.trezor.messages.eos.EosTxActionAck.EosAssetR\x0bcpuQuantity\x1a'\n\x0f\
    EosActionRefund\x12\x14\n\x05owner\x18\x01\x20\x02(\x04R\x05owner\x1a\
    \x90\x01\n\x0fEosActionBuyRam\x12\x14\n\x05payer\x18\x01\x20\x02(\x04R\
    \x05payer\x12\x1a\n\x08receiver\x18\x02\x20\x02(\x04R\x08receiver\x12K\n\
    \x08quantity\x18\x03\x20\x02(\x0b2/.hw.trezor.messages.eos.EosTxActionAc\
    k.EosAssetR\x08quantity\x1a^\n\x14EosActionBuyRamBytes\x12\x14\n\x05paye\
    r\x18\x01\x20\x02(\x04R\x05payer\x12\x1a\n\x08receiver\x18\x02\x20\x02(\
    \x04R\x08receiver\x12\x14\n\x05bytes\x18\x03\x20\x02(\rR\x05bytes\x1aB\n\
    \x10EosActionSellRam\x12\x18\n\x07account\x18\x01\x20\x02(\x04R\x07accou\
    nt\x12\x14\n\x05bytes\x18\x02\x20\x02(\x04R\x05bytes\x1aa\n\x15EosAction\
    ...
    \x02\x20\x02(\x04R\npermission\x12\x16\n\x06parent\x18\x03\x20\x02(\x04R\
    \x06parent\x12K\n\x04auth\x18\x04\x20\x02(\x0b27.hw.trezor.messages.eos.\
    EosTxActionAck.EosAuthorizationR\x04auth\x1aO\n\x13EosActionDeleteAuth\
    \x12\x18\n\x07account\x18\x01\x20\x02(\x04R\x07account\x12\x1e\n\npermis\
    sion\x18\x02\x20\x02(\x04R\npermission\x1aw\n\x11EosActionLinkAuth\x12\
    \x18\n\x07account\x18\x01\x20\x02(\x04R\x07account\x12\x12\n\x04code\x18\
    \x02\x20\x02(\x04R\x04code\x12\x12\n\x04type\x18\x03\x20\x02(\x04R\x04ty\
    pe\x12\x20\n\x0brequirement\x18\x04\x20\x02(\x04R\x0brequirement\x1aW\n\
    \x13EosActionUnlinkAuth\x12\x18\n\x07account\x18\x01\x20\x02(\x04R\x07ac\
    count\x12\x12\n\x04code\x18\x02\x20\x02(\x04R\x04code\x12\x12\n\x04type\
    \x18\x03\x20\x02(\x04R\x04type\x1a\xe3\x01\n\x13EosActionNewAccount\x12\
    \x18\n\x07creator\x18\x01\x20\x02(\x04R\x07creator\x12\x12\n\x04name\x18\
    \x02\x20\x02(\x04R\x04name\x12M\n\x05owner\x18\x03\x20\x02(\x0b27.hw.tre\
    zor.messages.eos.EosTxActionAck.EosAuthorizationR\x05owner\x12O\n\x06act\
    ive\x18\x04\x20\x02(\x0b27.hw.trezor.messages.eos.EosTxActionAck.EosAuth\
    orizationR\x06active\x1aN\n\x10EosActionUnknown\x12\x1b\n\tdata_size\x18\
    \x01\x20\x02(\rR\x08dataSize\x12\x1d\n\ndata_chunk\x18\x02\x20\x02(\x0cR\
    ...
    \x20device\x20for\x20Eos\x20public\x20key\x20corresponding\x20to\x20addr\
    ess_n\x20path\n\x20@start\n\x20@next\x20EosPublicKey\n\x20@next\x20Failu\
    re\n\n\n\n\x03\x04\0\x01\x12\x03\r\x08\x17\nI\n\x04\x04\0\x02\0\x12\x03\
    \x0e\x04\"\"<\x20BIP-32\x20path\x20to\x20derive\x20the\x20key\x20from\
    \x20master\x20node\x2044'/194'/0'\n\n\x0c\n\x05\x04\0\x02\0\x04\x12\x03\
    \x0e\x04\x0c\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\x0e\r\x13\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03\x0e\x14\x1d\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\
    \x0e\x20!\nC\n\x04\x04\0\x02\x01\x12\x03\x0f\x04#\"6\x20optionally\x20sh\
    ow\x20on\x20display\x20before\x20sending\x20the\x20result\n\n\x0c\n\x05\
    ...
    \x01\x1aO*\n\x20Response:\x20Contains\x20an\x20Eos\x20public\x20key\x20d\
    erived\x20from\x20device\x20private\x20seed\n\x20@end\n\n\n\n\x03\x04\
    \x01\x01\x12\x03\x16\x08\x14\n-\n\x04\x04\x01\x02\0\x12\x03\x17\x04'\"\
    \x20\x20EOS\x20pub\x20key\x20in\x20Base58\x20encoding\n\n\x0c\n\x05\x04\
    \x01\x02\0\x04\x12\x03\x17\x04\x0c\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\
    \x17\r\x13\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x17\x14\"\n\x0c\n\x05\
    \x04\x01\x02\0\x03\x12\x03\x17%&\n\x1d\n\x04\x04\x01\x02\x01\x12\x03\x18\
    \x04&\"\x10\x20Raw\x20public\x20key\n\n\x0c\n\x05\x04\x01\x02\x01\x04\
    \x12\x03\x18\x04\x0c\n\x0c\n\x05\x04\x01\x02\x01\x05\x12\x03\x18\r\x12\n\
    \x0c\n\x05\x04\x01\x02\x01\x01\x12\x03\x18\x13!\n\x0c\n\x05\x04\x01\x02\
    \x01\x03\x12\x03\x18$%\nb\n\x02\x04\x02\x12\x04!\02\x01\x1aV*\n\x20Reque\
    st:\x20Ask\x20device\x20to\x20sign\x20transaction\n\x20@start\n\x20@next\
    \x20EosTxRequest\n\x20@next\x20Failure\n\n\n\n\x03\x04\x02\x01\x12\x03!\
    \x08\x11\nI\n\x04\x04\x02\x02\0\x12\x03\"\x04\"\"<\x20BIP-32\x20path\x20\
    to\x20derive\x20the\x20key\x20from\x20master\x20node\x2044'/194'/0'\n\n\
    \x0c\n\x05\x04\x02\x02\0\x04\x12\x03\"\x04\x0c\n\x0c\n\x05\x04\x02\x02\0\
    \x05\x12\x03\"\r\x13\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03\"\x14\x1d\n\
    \x0c\n\x05\x04\x02\x02\0\x03\x12\x03\"\x20!\n$\n\x04\x04\x02\x02\x01\x12\
    \x03#\x04\x20\"\x17\x20256-bit\x20long\x20chain\x20id\n\n\x0c\n\x05\x04\
    \x02\x02\x01\x04\x12\x03#\x04\x0c\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\
    \x03#\r\x12\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\x03#\x13\x1b\n\x0c\n\x05\
    \x04\x02\x02\x01\x03\x12\x03#\x1e\x1f\n%\n\x04\x04\x02\x02\x02\x12\x03$\
    \x04$\"\x18\x20EOS\x20transaction\x20header\n\n\x0c\n\x05\x04\x02\x02\
    \x02\x04\x12\x03$\x04\x0c\n\x0c\n\x05\x04\x02\x02\x02\x06\x12\x03$\r\x18\
    \n\x0c\n\x05\x04\x02\x02\x02\x01\x12\x03$\x19\x1f\n\x0c\n\x05\x04\x02\
    \x02\x02\x03\x12\x03$\"#\n\x20\n\x04\x04\x02\x02\x03\x12\x03%\x04$\"\x13\
    \x20number\x20of\x20actions\n\n\x0c\n\x05\x04\x02\x02\x03\x04\x12\x03%\
    \x04\x0c\n\x0c\n\x05\x04\x02\x02\x03\x05\x12\x03%\r\x13\n\x0c\n\x05\x04\
    \x02\x02\x03\x01\x12\x03%\x14\x1f\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\
    \x03%\"#\n?\n\x04\x04\x02\x03\0\x12\x04*\x041\x05\x1a1*\n\x20Structure\
    \x20representing\x20EOS\x20transaction\x20header\n\n\x0c\n\x05\x04\x02\
    \x03\0\x01\x12\x03*\x0c\x17\n2\n\x06\x04\x02\x03\0\x02\0\x12\x03+\x08'\"\
    #\x20time\x20at\x20which\x20transaction\x20expires\n\n\x0e\n\x07\x04\x02\
    \x03\0\x02\0\x04\x12\x03+\x08\x10\n\x0e\n\x07\x04\x02\x03\0\x02\0\x05\
    \x12\x03+\x11\x17\n\x0e\n\x07\x04\x02\x03\0\x02\0\x01\x12\x03+\x18\"\n\
    \x0e\n\x07\x04\x02\x03\0\x02\0\x03\x12\x03+%&\nF\n\x06\x04\x02\x03\0\x02\
    \x01\x12\x03,\x08*\"7\x2016-bit\x20specifies\x20a\x20block\x20num\x20in\
    \x20the\x20last\x202^16\x20blocks.\n\n\x0e\n\x07\x04\x02\x03\0\x02\x01\
    \x04\x12\x03,\x08\x10\n\x0e\n\x07\x04\x02\x03\0\x02\x01\x05\x12\x03,\x11\
    \x17\n\x0e\n\x07\x04\x02\x03\0\x02\x01\x01\x12\x03,\x18%\n\x0e\n\x07\x04\
    \x02\x03\0\x02\x01\x03\x12\x03,()\nO\n\x06\x04\x02\x03\0\x02\x02\x12\x03\
    -\x08-\"@\x20specifies\x20the\x20lower\x2032\x20bits\x20of\x20the\x20blo\
    ckid\x20at\x20get_ref_blocknum\n\n\x0e\n\x07\x04\x02\x03\0\x02\x02\x04\
    \x12\x03-\x08\x10\n\x0e\n\x07\x04\x02\x03\0\x02\x02\x05\x12\x03-\x11\x17\
    \n\x0e\n\x07\x04\x02\x03\0\x02\x02\x01\x12\x03-\x18(\n\x0e\n\x07\x04\x02\
    \x03\0\x02\x02\x03\x12\x03-+,\ne\n\x06\x04\x02\x03\0\x02\x03\x12\x03.\
    \x080\"V\x20upper\x20limit\x20on\x20total\x20network\x20bandwidth\x20(in\
    \x208\x20byte\x20words)\x20billed\x20for\x20this\x20transaction\n\n\x0e\
    \n\x07\x04\x02\x03\0\x02\x03\x04\x12\x03.\x08\x10\n\x0e\n\x07\x04\x02\
    \x03\0\x02\x03\x05\x12\x03.\x11\x17\n\x0e\n\x07\x04\x02\x03\0\x02\x03\
    \x01\x12\x03.\x18+\n\x0e\n\x07\x04\x02\x03\0\x02\x03\x03\x12\x03../\nT\n\
    \x06\x04\x02\x03\0\x02\x04\x12\x03/\x08-\"E\x208-bit\x20upper\x20limit\
    \x20on\x20the\x20total\x20CPU\x20time\x20billed\x20for\x20this\x20transa\
    ction\n\n\x0e\n\x07\x04\x02\x03\0\x02\x04\x04\x12\x03/\x08\x10\n\x0e\n\
    \x07\x04\x02\x03\0\x02\x04\x05\x12\x03/\x11\x17\n\x0e\n\x07\x04\x02\x03\
    \0\x02\x04\x01\x12\x03/\x18(\n\x0e\n\x07\x04\x02\x03\0\x02\x04\x03\x12\
    \x03/+,\na\n\x06\x04\x02\x03\0\x02\x05\x12\x030\x08&\"R\x20number\x20of\
    \x20seconds\x20to\x20delay\x20this\x20transaction\x20for\x20during\x20wh\
    ich\x20it\x20may\x20be\x20canceled.\n\n\x0e\n\x07\x04\x02\x03\0\x02\x05\
    \x04\x12\x030\x08\x10\n\x0e\n\x07\x04\x02\x03\0\x02\x05\x05\x12\x030\x11\
    \x17\n\x0e\n\x07\x04\x02\x03\0\x02\x05\x01\x12\x030\x18!\n\x0e\n\x07\x04\
    \x02\x03\0\x02\x05\x03\x12\x030$%\nQ\n\x02\x04\x03\x12\x048\0:\x01\x1aE*\
    \n\x20Response:\x20Device\x20asks\x20to\x20upload\x20next\x20action\n\
    \x20@next\x20EosTxActionAck\n\n\n\n\x03\x04\x03\x01\x12\x038\x08\x1a\n\
